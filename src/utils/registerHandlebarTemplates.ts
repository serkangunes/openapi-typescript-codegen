...
import partialExportKotlinClassWithSuper from '../templates/partials/exportKotlinClassWithSuper.hbs';
...
export const registerHandlebarTemplates = (root: {
    ...
    Handlebars.registerPartial('exportKotlinClassWithSuper', Handlebars.template(partialExportKotlinClassWithSuper));
